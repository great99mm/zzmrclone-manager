...
export const getQuotaAccounts = () => api.get('/quota-accounts');
export const createQuotaAccount = (data) => api.post('/quota-accounts', data);
export const updateQuotaAccount = (id, data) => api.put(`/quota-accounts/${id}`, data);
